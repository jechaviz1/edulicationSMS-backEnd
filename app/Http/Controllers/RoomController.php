...
class RoomController extends Controller
{
    public function index(Request $request){
        ...
        return view('admin.room.calender.list',['view' => 'month','calendar' => $calendar,'prevMonth' => $prevMonth,'next' => $next]);
        }else{
            if ($request->filled('date')) {
                // dd($request);
            ...
            return view('admin.room.calender.list', ['view' => 'week','weekDays' => $weekDays,'prev' => $prev,'next' => $next]);
        }
