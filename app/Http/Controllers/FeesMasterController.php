...
class FeesMasterController extends Controller {
    ...
    public function index(Request $request) {
        $data = [];
        $data['title'] = 'Fees Master';
        $data['menu_active_tab'] = 'fees-master';
        ...
        $data['rows'] = $masters->orderBy('id', 'desc')->get();

        return view('admin.fees_master.index')->with($data);
    }
    ...
    public function add(Request $request)
    {
        ...
        $data['menu_active_tab'] = 'add-fees-master';
        ...
        return view('admin.fees_master.add')->with($data);
    }
    ...
    public function store(Request $request) {
        ...
        try{
            ...
            return redirect()->route('list-fees-master')->with('success', 'Record Added.');
