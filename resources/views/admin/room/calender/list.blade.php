        ...
        <div class="card-header">
            <div class="row">
                <div class="col-sm-6 d-flex align-items-center justify-content-start">
                    <div>
                        <h4 class="card-title">Events - Room Calendar</h4>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex">
                                    <span class="me-2">Rooms : </span>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"  name="rooms" value="" checked>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            With sessions     
                                        </label>
                                      </div>
                                      <div class="form-check ms-3">
                                        <input class="form-check-input" type="radio" name="rooms" value="" id="flexRadioDefault2" >
                                        <label class="form-check-label" for="flexRadioDefault2">
                                            All
                                        </label>
                                      </div>
                ...
                <div class="row mt-4">
                    @if($view == 'month')
                        ...
                        <table class="">
                            ...
                            <thead>
                                <tr class="py-2">
                                    <td  class="text-center py-2" style="border-bottom:#ffffff 1px solid;border-right:#ffffff 1px solid;width:55px;background:#bfda73;color:#fff;">
                                        Room
                                    </td>
