                        ...
                        <div class="card bg-primary-light">
                            <div class="card-body depostit-card">
                                <div class="depostit-card-media d-flex justify-content-between">
                                    <div>
                                        <h6 class="font-w400 mb-0">School Count</h6>
                                        <h3>{{count($school)}}</h3>
                                    </div>
                                    <div class="icon-box">
                        ...
                        <div class="card same-card-chart bg-danger-light diposit-bg">
                            <div class="card-body depostit-card p-0">
                                <div class="depostit-card-media d-flex justify-content-between pb-0">
                                    <div>
                                        <h6 class="mb-0 font-w400">Super Admin Count</h6>
                                        <h3>{{count($super_admin)}}</h3>
                                    </div>
                        ...
                        <div class="card bg-warning-light">
                            <div class="card-header border-0 flex-wrap">
                                <div class="revenue-date">
                                    <h6 class="mb-0 font-w400">School Count</h6>
                                    <h4 class="">{{count($school)}}</h4>
                                </div>
...
<script src="{{ asset('admin/js/dashboard/apexchart.js')}}"></script>
