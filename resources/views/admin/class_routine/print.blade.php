  ...
  <div class="template-inner">
    ...
    <table class="table-border">
        <thead>
            ...
            @if($loop->first)
            <tr>
                <th>{{ ('Program') }}: {{ $row->program->shortcode ?? '' }}</th>
                <th>{{('Session') }}: {{ $row->session->title ?? '' }}</th>
                <th>{{ ('Semester') }}: {{ $row->semester->title ?? '' }}</th>
                <th>{{ ('Section') }}: {{ $row->section->title ?? '' }}</th>
            </tr>
            @endif
            @endforeach
      </thead>
