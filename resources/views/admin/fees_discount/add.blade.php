    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create Fees Discount</h4>
            ...
            <div class="card-body">
                <div class="form-validation">
                    <h5>Add Fees Discount</h5>

                    <form class="needs-validation" novalidate  method="POST" action="{{ route('store-fees-discount') }}" >
                            @csrf
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="date" class="form-control" id="validationCustom02"  placeholder="Title" required name="start_date">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="date" class="form-control" id="validationCustom02"  placeholder="Title" required name="end_date">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom02"  placeholder="Amount" required name="amount">
                                            <div class="invalid-feedback">
