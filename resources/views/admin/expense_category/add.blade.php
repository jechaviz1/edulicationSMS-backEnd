        ...
        <div class="card">
            <div class="card-header">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('expense_categoris') }}" class="btn btn-primary light">Expense Category list</a>
                    </li>
            ...
            <div class="card-body">
                <div class="form-validation">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('store_expense_category') }}" >
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="mb-3 row">
