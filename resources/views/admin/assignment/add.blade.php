            ...
            <div class="card-header">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('assignment-list') }}" class="btn btn-primary light">Assignment list</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="form-validation">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('store-assignment') }}" >
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="mb-3 row">
