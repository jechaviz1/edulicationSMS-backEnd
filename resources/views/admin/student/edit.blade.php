                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" placeholder="yyyy-mm-dd" id="mdates" name="dob" value="{{$student->date_of_birth}}" >
                                            <div class="invalid-feedback">
                                                Date of Birth.
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom08" placeholder="212-999-0000" required name="contact_number" value="{{$student->contact_number}}">
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom02"  placeholder="First Guardian Name" required name="first_guardian_name" value="{{$student->first_guardian_name}}" >
                                            <div class="invalid-feedback">
                                                First Guardian Name
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom02"  placeholder="Second  Guardian Name" required name="second_guardian_name" value="{{$student->second_guardian_name}}">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom08" placeholder="212-999-0000" required name="first_guardian_contact_name" value="{{$student->first_guardian_contact_name}}">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class=" wide form-control" id="relation" name="relation">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="validationCustom12" required name="terms_condition_check" {{$student->terms_condition_check == '1' ? 'checked' : '' }} >
