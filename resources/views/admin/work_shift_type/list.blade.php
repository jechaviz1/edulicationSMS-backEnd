...
<div class="col-xl-12">
    <div class="card dz-card" id="accordion-four">
        <div class="card-header flex-wrap d-flex justify-content-between">
            <div>
                <h4 class="card-title">Work Shift Type List</h4>
            </div>
            <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="{{ URL::route('add-work-shift-type') }}" class="btn btn-primary light">Add Work Shift Type</a>
                </li>
                <!--                <li class="nav-item" role="presentation">
                    ...
                    <div class="table-responsive">
                        <table id="example4" class="display table" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                @foreach ($work_shift_type as $k=> $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('edit-work-shift-type',$row->id) }}" class="btn btn-primary light shadow btn-xs sharp me-1"><i class="fa fa-pencil"></i></a>
                                            <a href="{{ route('delete-work-shift-type',$row->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
