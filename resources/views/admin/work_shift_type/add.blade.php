    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create Work Shift Type</h4>
            ...
            <div class="card-body">
                <div class="form-validation">
                    <h5>Add Work Shift Type</h5>

                    <form class="needs-validation" novalidate method="POST" action="{{ route('store-work-shift-type') }}" >
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="mb-3 row">
