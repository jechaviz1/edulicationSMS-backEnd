        ...
        <div class="card">
            <div class="card-header">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('program-list') }}" class="btn btn-primary light">Program list</a>
                    </li>
            ...
            <div class="card-body">
                <div class="form-validation">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('store-program') }}" >
                        @csrf
                      
                        <div class="row">
                        <div class="col-xl-4">
                                <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="faculty">Faculty<span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                   
                                            <select class="default-select wide form-control" id="faculty" name="faculty" required>
                                            @if(!empty($faculties))
