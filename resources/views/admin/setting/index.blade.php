        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    ...
                    <form class="needs-validation" novalidate  method="POST" action="{{ route('store-setting') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Site Title<span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Meta Description<span class="text-danger">Max length 160 characters</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Site Logo <span class="text-danger">Best Resolution Height- 200 PX, Width- Any PX</span>
                                        </label>
                                        <div class="col-lg-6">
                                            @if(isset($row->logo_path))
                                            <img src="{{ asset('/setting/'.$row->logo_path) }}" class="img-fluid" style="max-width: 80px; max-height: 80px;">
                                            @endif
                                           <input type="file" class="form-control" name="logo" id="logo">
                                            <div class="invalid-feedback">
                                                Please enter select logo.
                                            </div>
                                  ...
                                  @if(isset($row->date_format))
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Date Format <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Time Format <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            ...
                                            <div class="invalid-feedback">
                                                Please enter select time formate.
                                            </div>
                                    ...
                                    @endif
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Currency  <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Copyright Text <span class="text-danger"></span>
                                        </label>
                                        <div class="col-lg-6">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Meta Title <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Meta Keywords: <span class="text-danger">Separate Every Keyword by Using (,) Symbol</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Site Favicon:  <span class="text-danger">Best Resolution Height- 64 PX, Width- 64 PX</span>
                                        </label>
                                        <div class="col-lg-6">
                                            @if(isset($row->favicon_path))
                                            <img src="{{ asset('/setting/'.$row->favicon_path) }}" class="img-fluid" style="max-width: 80px; max-height: 80px;">
                                            @endif
                                            <input type="file" class="form-control" name="favicon" id="favicon">
                                            <div class="invalid-feedback">
                                                Please select fevicone icon.
                                            </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Time Zone  <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                    ...
                                    @endif
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Currency Symbol  <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            ...
                                            <div class="invalid-feedback">
                                                Please enter carrency symbol.
                                            </div>

                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Decimal Place  <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
