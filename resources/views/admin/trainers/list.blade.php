        ...
        <div class="card-header">
            <div class="row">
                <div class="col-sm-6 d-flex align-items-center justify-content-start">
                    <div>
                        <h4 class="card-title">Events - Trainer Calendar</h4>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="d-flex">
                                    <span class="me-2">Trainers : </span>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"  name="trainers" value="wityh_sessions" checked>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            With sessions     
                                        </label>
                                      </div>
                                      <div class="form-check ms-3">
                                        <input class="form-check-input" type="radio" name="trainers" value="all" id="flexRadioDefault2" >
                                        <label class="form-check-label" for="flexRadioDefault2">
                                            All
                                        </label>
                                      </div>
                            ...
                            <div class="col-sm-4">
                                <div class="d-flex">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"  name="sessions" value="active" checked>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Active   
                                        </label>
                                      </div>
                                      <div class="form-check ms-3">
                                        <input class="form-check-input" type="radio" name="sessions" value="all" id="flexRadioDefault2" >
                                        <label class="form-check-label" for="flexRadioDefault2">
                                            All
                                        </label>
                                      </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#date').change(function() {
            ...
            $('input[type="radio"][name="sessions"]').change(function(){
                if($(this).is(':checked')){
                    var radioValue = $(this).val();
                    console.log(radioValue);
                //   var domain =  window.location.origin
                //   window.location = domain;
                window.location.href = "?sessions=" + radioValue;
                }
            });
            $('input[type="radio"][name="trainers"]').change(function(){
                if($(this).is(':checked')){
                    var radioValue = $(this).val();
                    console.log(radioValue);
                //   var domain =  window.location.origin
