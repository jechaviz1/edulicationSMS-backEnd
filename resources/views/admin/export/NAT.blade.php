            ...
            <div class="card-block p-3">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <form action="{{ route('nat.generator') }}" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
                            @csrf()
                            @method('POST')
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control w-100" name="reportingState" id="reportingState"
                                                ...
                                                <option value="0">All – Use to check data, not for
                                                    submission&nbsp;&nbsp;&nbsp;&nbsp;</option>
                                        ...
                                        <div class="col-sm-12 mt-3">
                                            <input type="checkbox" name="yetToStart" id="yetToStart" value="yetToStart">
                                            Include
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-sm-6">
                                            <input type="radio" name="reportdateselection"
                                                id="reportdateselection2_8_0" value="date">
                                            Reporting date range
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="date" class="" name="exportDateFrom"
                                                id="exportDateFrom_8_0" placeholder="From" class="hasDatepicker">
                                            <input type="date" class="" name="exportDateTo"
                                                id="exportDateTo_8_0" placeholder="To" class="hasDatepicker">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left" style="line-height:25px;width:40%">
                                            ...
                                            <input class="reportType_e_8_0" type="checkbox" name="NAT00010A"
                                                id="NAT00010A" value="NAT00010A"> NAT00010A (Training
                                            Organisation)<br><!--WWB-220-->
                                            <input class="reportType_e_8_0" type="checkbox" name="NAT00030A"
                                                id="NAT00030A" value="NAT00030A"> NAT00030A (Program)<!--WWB-220-->
                                        ...
                                        <td style="text-align:left;" rowspan="2">
                                            ...
                                            <span style="font-size:small;">
                                                *Please note:<br>
                                                While every effort is made to ensure compliance of data format with
                                                reporting
                                                requirements, DNA Progression Pty Ltd makes no representation in this or any
                                                other respect. It is
                                                a condition of Weworkbook that DNA Progression Pty Ltd accepts no
                                                responsibility
                                                ...
                                                required by that user's reporting jurisdiction and that it meets all
                                                validation
                                                and other
                                            ...
                                            <button style="font-family: inherit" type="submit"
                                                class="btn btn-primary">Generate</button>
                                            <button style="font-family: inherit" type="submit"
                                                class="btn btn-primary">Generate - State</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" style="overflow: scroll;">
                        <table class="table w-100">
                            <thead>
                              <tr>
                                <th scope="col">Date From</th>
                                <th scope="col">Date To</th>
                                <th scope="col">NAT File</th>
                                <th scope="col">No Out Come</th>
                                <th scope="col">Generated By</th>
                                <th scope="col">Exclusion</th>
                                <th scope="col">Inclusion</th>
                                <th scope="col">Version</th>
                                <th scope="col">Reporting State</th>
                                <th scope="col">Start Enrolments</th>
    ...
    @push('scripts')
        <script>
            function startSearchBy() {
                ...
                jQuery('#tagbox2').tagdragon({
                    'field': 'searchValueName1',
                    'url': '../widgetFunctions/loadCoursesCode.php',
                    'max': '10'
                });
            ...
            function changeSearchBy() {
                ...
                switch (document.getElementById('searchBy1').value) {
                    ...
                    case 'client':
                        ...
                        jQuery('#tagbox2').tagdragon({
                            'field': 'searchValue1',
                            'url': '../widgetFunctions/loadPeople.php',
                            'max': '10'
                        });
                        break;
                    case 'specificUnit':
                        ...
                        jQuery('#tagbox2').tagdragon({
                            'field': 'searchValueRef1',
                            'url': '../widgetFunctions/loadCourseUnitsCode.php',
                            'max': '10'
                        });
                        break;
                    case 'event':
                    ...
                    case 'clientGroupName':
                        ...
                        jQuery('#tagbox2').tagdragon({
                            'field': 'searchValueGroup',
                            'url': '../widgetFunctions/loadClientGroupName.php',
                            'max': '10'
                        });
                        break;
                    case 'city':
                        ...
                        jQuery('#tagbox2').tagdragon({
                            'field': 'searchCity',
                            'url': '../widgetFunctions/loadCities.php',
                            'max': '10'
                        });
                        break;
                }
                    ...
                    if (query.length > 0) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                .items; // Assuming response.items contains the search results
                                var html = '';
