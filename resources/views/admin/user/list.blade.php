                        ...
                        <table id="example4" class="display table" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->email}}</td>
                                    <td>{{$row->username}}</td>
                                    <td><span class="badge badge-sm  badge-info light">{{$row->name}}</span></td>
                                    <td><span class="badge badge-sm light badge-success">Paid</span></td>
                                    <td>2011/04/25</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('edit-user',$row->id) }}" class="btn btn-primary light shadow btn-xs sharp me-1"><i class="fa fa-pencil"></i></a>
                                            <a href="{{ route('delete-user',$row->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
