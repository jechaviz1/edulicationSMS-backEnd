        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-validation">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('update-batch',$batch->id) }}" >
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="title" placeholder="Your valid title." required name="title" value="{{$batch->title}}">
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="start_date"  required name="start_date" value="{{$batch->start_date}}">
                                        <div class="invalid-feedback">
                            ...
                            <label class="col-lg-3 col-form-label" for="program">Assign Programs <span class="text-danger">*</span></label><br/>
                                ...
                                <br/>
                                    <div class="checkbox d-inline">
                                        <input type="checkbox" name="programs[]" id="program-{{ $key }}-{{ $batch->id }}" value="{{ $program->id }}"

                                        @foreach($batch->programs as $selected_program)
                                            @if($selected_program->id == $program->id) checked @endif 
                                        @endforeach

                                        >
                                        <label for="program-{{ $key }}-{{ $batch->id }}" class="cr">{{ $program->title }}</label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            <option value="0" @if( $batch->status == 0 ) selected @endif>Inactive</option>
                                        </select>
                                    </div>
