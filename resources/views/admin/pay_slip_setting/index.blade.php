    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Pay Slip Setting</h4>

            </div>
            <div class="card-body">
                <div class="form-validation">
                    <h5>Pay Slip Setting</h5>

                    <form class="needs-validation" novalidate  method="POST" action="{{ route('store-pay-slip-setting') }}" enctype="multipart/form-data">
                            @csrf

                            <div class="row">
                                <div class="col-xl-6">
                            <input name="id" type="hidden" value="{{ (isset($pay_slip_setting->id))?$pay_slip_setting->id:-1 }}">
                            <input name="slug" type="hidden" value="pay-slip">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom02"  placeholder="Title" required name="title" value="{{@$pay_slip_setting->title}}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" name="footer_left" id="footer_left">{{@$pay_slip_setting->footer_left}}</textarea>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" name="footer_right" id="footer_right">{{@$pay_slip_setting->footer_right}}</textarea>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="width" id="width" value="{{@$pay_slip_setting->width}}">
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            @if(isset($pay_slip_setting->logo_right))
                                            <img src="{{ asset('/pay_slip_setting/'.$pay_slip_setting->logo_right) }}" class="img-fluid" style="max-width: 80px; max-height: 80px;">
                                            @endif
