                ...
                <div class="form-validation">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('store-teacher') }}" >
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="mb-3 row">
                                    <label class="col-lg-3 col-form-label" for="validationCustom02">First Name <span class="text-danger">*</span></label>
                                    <div class="col-lg-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-check custom-checkbox mb-3 checkbox-info">
                                            <input type="checkbox" class="form-check-input" id="customCheckBox{{$k}}" name="subject_id[]" value="{{$row->id}}"   />
