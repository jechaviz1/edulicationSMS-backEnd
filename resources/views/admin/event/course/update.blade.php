        ...
        <div class="tab-pane fade show active" id="nav-enrolments" role="tabpanel" aria-labelledby="nav-home-tab">
            <div class="mt-3 mb-3">
                <div class="" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">SMS
                        all learners</button>
                    <button type="button" class="btn btn-primary ms-2">Send Survey</button>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#certificate_manage">Manage Certificates</button>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#addenrolments">Add Enrolments</button>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#enrollment_unit">Enrol Units</button>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#enrollment_out_comes">Update Outcomes</button>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#enrollment_invoice">Create Invoice</button>
                </div>
            </div>
            {{-- // tables start --}}
                    ...
                    @if (!empty($enrollments))
                        @foreach ($enrollments as $k => $row)
                            ...
                            <tr>
                                ...
                                <td>No</td>
                                <td>
                                    <a href="{{ route('event.enrollment.people.update', $row->id) }}" class="btn"><i
                                            title="Edit" class="fa fa-pencil fa-2x mr-2 text-info"></i></a>
                                    <a href="" class="btn "><i title="Delete Enrolment"
                                            class="fa fa-trash fa-2x mr-2 text-danger"></i></a>
                                    <a href="" class=""><i title="Delete E-Form"
                                            class="fa fa-trash fa-2x mr-2 text-danger"></i></a>
                                    <a href="" class=""><i title="Issue Document"
                                            class="fa fa-file fa-2x text-primary mr-2"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ($enrollments as $k => $row)
                                                @php
                                                    $issue_certificate = App\Models\IssueCertificate::where(
                                                        'enrolment_id',
                                                        $row->id,
                                                    )->first();
                                                @endphp
                                                <tr>
                                                    ...
                                                    <th>{{ $row->student->first_name }} {{ $row->student->last_name }}
                                                    </th>
                                                    <td>{{ $row->paymentStatus }}</td>
                                                    <td>
                                    ...
                                    <form action="">
                                            ...
                                            <div class="col-8">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="certificate_method" id="inlineRadio1" value="post">
                                                    <label class="form-check-label" for="inlineRadio1">Post</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="certificate_method" id="inlineRadio2" value="email">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-8">
                                                <input type="text" name="ReissueReason" id="ReissueReason"
                                                    class="form-control" style="width:100%;">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-8">
                                                <textarea type="text" name="certificateComments" class="form-control" id="certificateComments"
                                                    style="width:314px;"></textarea>
                                            </div>
                                        </div>
                                            ...
                                            @foreach ($enrollments as $k => $row)
                                                ...
                                                @if ($issue_certificate != null)
                                                    <tr>
                                                        ...
                                                        <td>{{ $row->student->first_name }} {{ $row->student->last_name }}
                                                        </td>
                                        ...
                                        @if (!empty($enrollments))
                                            @foreach ($enrollments as $k => $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox"
                                                            name="unit[{{ $k }}][student_id]"
                                                            value="{{ $row->student->id }}">
                                                        <input type="hidden"
                                                            name="unit[{{ $k }}][course_id]"
                                                            value="{{ $row->course->id }}">
                                                    </td>
                                                </tr>
                                            @endforeach
            ...
            {{-- SMS All Enrollment End --}}
            {{--  All Enrollment  --}}
            <div class="modal fade" id="enrollment_out_comes" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                ...
                {{--  All Enrollment  --}}
                <div class="modal fade" id="enrollment_invoice" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="95%" align="center"
                    ...
                    <tbody>
                        ...
                        <tr style="height:30px;">
                            ...
                            <td align="center" style="border-bottom:1px solid rgb(164, 164, 164);">kuldip domadiya<br>
                            </td>
                            <td align="center" style="border-bottom:1px solid gray;"></td>
                        ...
                        <tr style="height:30px;">
                            <td colspan="8">
                                <div id="textlink_34643"
                                    style="line-height:25px; width:500px;  clear:both; display:block">
            ...
            <div class="tab-pane fade" id="nav-schedule" role="tabpanel" aria-labelledby="nav-contact-tab"> 
                <form class="mt-4" action="{{ route('edit.schedule.course')}}" method="post">
                    @csrf
                    @method('POST')
                    <div class="row">
                        ...
                        <div class="col-4 form-group">
                            ...
                            <input style="padding-left:1rem;width:18vw;" name="displayCourseID"
                                class="form-control mb-2" id="displayCourseID" type="text"
                                value="{{ $course_event->course_name }}" disabled>
                        </div>
                        <div class="col-2 mt-2 form-group">
                            <label>Schedule ID</label>
                        </div>
                        <div class="col-4 form-group">
                            <input style="" type="text" name="displayScheduleID" id="displayScheduleID" class="form-control" value="{{$course_event->id}}" disabled="">
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        {{-- @dd($course_event->citys->name) --}}
                        <div class="col-4 form-group form-inline">
                            <input style="" type="text" name="displayScheduleID" id="displayScheduleID" class="form-control" value="{{$course_event->citys->name}}" disabled>
                        </div>
                        <div class="col-2 form-group form-group">
                            <label>Group (Company if applicable)</label>
                        </div>
                        <div class="col-4 form-group form-inline">
                            <input style="width:12vw;" type="text" maxlength="15" class="form-control" name="groupname34643" id="groupname34643" value="">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-2 mt-2 form-group">
                ...
                <div id="ui-tabs-4" class="ui-tabs-panel ui-widget-content ui-corner-bottom" aria-live="polite"
                    ...
                    <div id="sms_opportunities">
                        ...
                        <div class="modal-content">
                            ...
                            <h5>Send SMS</h5>
                            <div style="padding:0px 0px 10px 20px;"><b>Note: </b>Sending one SMS message will cost you
                                $0.09
                                (AUD, GST Excl).
                            </div>
                            <form action="{{ route('event.course.sendAllLearnersSMS') }}" method="post">
                                ...
                                <input type="hidden" name="event_id" value="{{ $course_event->id }}">
                            <textarea name="sms_Content" id="sms_Content" style="width:600px;height:200px;"></textarea>
                            <button type="submit" id="submit-sms" class="btn btn-primary mt-4"
