            ...
            <div class="card-header">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ URL::route('content-list') }}" class="btn btn-primary light">Content List</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="form-validation">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('update-content', $content->id ) }}" >
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="validationCustom02" placeholder="Enter Title" required name="title" value="{{$content->title}}">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" name="content_type" id="content_type">
                                            ...
                                            <option value="{{$row->id}}" {{ $row->id == $content->content_type ? 'selected' : '' }}  >{{$row->title}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
