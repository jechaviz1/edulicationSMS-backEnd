        ...
        <div class="card">
            <div class="card-header">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('city-town-list') }}" class="btn btn-primary light">City Town list</a>
                    </li>
            ...
            <div class="card-body">
                <div class="form-validation">
                    <h5>Edit City Town</h5>

                    <form class="needs-validation" novalidate  method="POST" action="{{ route('update-city-town',$city_town->id ) }}" >
                            @csrf
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="validationCustom02"  placeholder="City Name" required name="city_name" value="{{$city_town->city_name}}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="default-select wide form-control" name="ragion_id" id="ragion_id"  required>
                                                ...
                                                <option value="{{ $ragion->id }}" @foreach($ragions as $selected_category) {{ $selected_category->id == $ragion->id ? 'selected' : '' }} @endforeach>{{ $ragion->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="default-select wide form-control" name="state" id="state" required>
                                                ...
                                                <option value="ACT" {{ @$city_town->state == 'ACT' ? 'selected' : '' }}>ACT</option>
                                                <option value="NSW" {{ @$city_town->state == 'NSW' ? 'selected' : '' }}>NSW</option>
                                                <option value="NT" {{ @$city_town->state == 'NT' ? 'selected' : '' }}>NT</option>
                                                <option value="QLD" {{ @$city_town->state == 'QLD' ? 'selected' : '' }}>QLD</option>
                                                <option value="SA" {{ @$city_town->state == 'SA' ? 'selected' : '' }}>SA</option>
                                                <option value="TAS" {{ @$city_town->state == 'TAS' ? 'selected' : '' }}>TAS</option>
                                                <option value="VIC" {{ @$city_town->state == 'VIC' ? 'selected' : '' }}>VIC</option>
                                                <option value="WA" {{ @$city_town->state == 'WA' ? 'selected' : '' }}>WA</option>
                                            </select>
                                            <div class="invalid-feedback">
                                                Please select state.
                                            </div>
